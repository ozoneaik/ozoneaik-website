                ...
                <div
                    ...
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                            ที่ ozoneaikDev เรามุ่งมั่นที่จะเป็นผู้นำในวงการพัฒนาเว็บไซต์ โดยใช้เทคโนโลยีล้ำสมัยเช่น
                            React.js, Next.js และ Laravel เราเชื่อในพลังของนวัตกรรม
                            และการสร้างสรรค์ที่สามารถยกระดับธุรกิจของคุณสู่ความสำเร็จ
                        </p>
                        <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                            <Link target={'_blank'} href={'https://github.com/ozoneaik'}
                               className="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                                <svg className="w-4 h-4 mr-2 text-gray-500 dark:text-gray-400"
                    ...
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <Image src={Hero ? Hero : ''} alt="hero image"/>
                    </div>
                </div>
            </section>
            <section className={'bg-gray-50 dark:bg-gray-800'}>
                <div className={'max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6'}>
                    <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                        ...
                        <img className="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="" alt="dashboard feature image"/>
                    </div>
                </div>
            </section>
        </>
